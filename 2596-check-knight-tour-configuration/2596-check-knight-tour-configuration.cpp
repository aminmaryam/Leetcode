...
public:
/*
in the 3d array if the knight travels according to the numbers in the array then that grid is valid otherwise not

at the point where knight is standing we can move in the following directions
1) r-2, c+1
2) r-1, c+2
3) r+2, c+1
4) r+1, c+2
